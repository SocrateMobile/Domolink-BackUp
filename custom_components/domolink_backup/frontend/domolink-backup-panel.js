...
class DomoLinkBackupPanel extends HTMLElement {
  ...
  set hass(hass) {
    ...
    if (updateEntity) {
      const d = this._data || {};
      const currentVer = this._version || (updateEntity.attributes && updateEntity.attributes.installed_version) || "1.5.1";
  ...
  _showUpdateModal() {
    ...
    const d = this._data || {};
    const currentVer = this._version || (updateEntity && updateEntity.attributes && updateEntity.attributes.installed_version) || "1.5.1";
